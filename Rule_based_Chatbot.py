...
destinations = {
    "beaches": ["Goa", "Kannur", "Cochin"],
    "mountains": ["Ooty", "Wayanad", "Kodaikanal"],
    "cities": ["Srinagar", "Jaipur", "Mumbai"]
}
...
def recommend():
    ...
    pref = input(Fore.YELLOW + "Which one do you prefer?: ")
    pref = normalize_input(pref)

    if pref in destinations:
        suggestion = random.choice(destinations[pref])
        print(Fore.GREEN + f"TravelBot: How about {suggestion}?")
        print(Fore.CYAN + "TravelBot: Would you like to visit here? (yes/no)")
        answer = input(Fore.YELLOW + "You: ").lower()

        if answer == "yes":
            print(Fore.GREEN + f"TravelBot: Wonderful! Have fun in {suggestion}!")
        elif answer == "no":
        ...
        print(Fore.RED + "TravelBot: Sorry, no informaion about this destination.")
        recommend()
